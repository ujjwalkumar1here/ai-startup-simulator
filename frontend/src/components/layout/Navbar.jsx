...
export default function Navbar({ onMenuClick, variant = "protected" }) {
  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-slate-100 bg-white/80 px-4 backdrop-blur-md sm:px-6">
      <div className="flex items-center gap-3">
        ...
        <Link to="/" className="flex items-center gap-2">
          ...
          <span className="text-lg font-bold text-slate-900">Startup Simulator</span>
        </Link>
      </div>
      ...
      {isAuthenticated ? (
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            ...
            {open && (
              <div className="absolute right-0 mt-2 w-48 overflow-hidden rounded-xl border border-slate-100 bg-white py-1 shadow-soft">
                <Link
                  to="/profile"
